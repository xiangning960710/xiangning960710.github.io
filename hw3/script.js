...
let x1 = 0, y1 = 0, dx1 = 5, dy1 = 5, r1 = 30, color1 = "#0072E3";
let x2 = canvas.width, y2 = 0, dx2 = 5, dy2 = 5, r2 = 30, color2 = "#00CACA";
...
// TODO：如果發生碰牆（畫布寬canvas.width、高canvas.height），則改變速度(dx, dy)和顏色(color)
